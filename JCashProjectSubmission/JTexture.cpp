...
#ifdef _SDL_TTF_H
bool JTexture::loadFromRenderedText( std::string textureText, SDL_Color textColor )
{
    //Get rid of preexisting texture
    free();
...
void JTexture::setColor( Uint8 red, Uint8 green, Uint8 blue )
{
...
void JTexture::setAlpha( Uint8 alpha )
{
